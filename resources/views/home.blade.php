                ...
                <div class="row h-100 align-items-center justify-content-center">
                    <div class="col-12 col-lg-9">
                        <div class="welcome-text text-center">
                            <h2 data-animation="fadeInUp" data-delay="300ms">check<span> result</span></h2>            
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="single-slide bg-img">
            ...
            <div class="container h-100">
                <div class="row h-100 align-items-center justify-content-center">
                    <div class="col-12 col-lg-9">
                        <div class="welcome-text text-center">
                            <h2 data-animation="fadeInDown" data-delay="300ms">designed by: <span>Uwangue Jovita</span></h2>
                        </div>
                    </div>
                </div>
            </div>
